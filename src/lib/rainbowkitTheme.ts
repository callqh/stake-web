...
myCustomTheme.colors.connectButtonInnerBackground = 'linear-gradient(0deg, rgba(6, 182, 212, 0.1) 0%, rgba(59, 130, 246, 0.1) 100%)'
...
myCustomTheme.colors.downloadBottomCardBackground = 'linear-gradient(126deg, rgba(6, 182, 212, 0.1) 9.49%, rgba(59, 130, 246, 0.1) 71.04%)'
myCustomTheme.colors.downloadTopCardBackground = 'linear-gradient(126deg, rgba(6, 182, 212, 0.2) 9.49%, rgba(59, 130, 246, 0.2) 71.04%)'
